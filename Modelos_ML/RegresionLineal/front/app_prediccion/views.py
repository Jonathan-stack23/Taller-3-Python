    ...
    if request.method == 'POST':
        ...
        if area_m2:
            try:
                ...
                context['error'] = f"No se puede conectar a la API ({api_base}). Verifica la API_URL y que el backend esté levantado."
            except requests.exceptions.Timeout as e:
                context['error'] = f"Tiempo de espera agotado al contactar la API ({api_base})."
